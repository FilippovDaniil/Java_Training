...
Базовый JUnit разобран в [модуле 28](../module-28-junit/theory.md). Здесь — **Mockito**: библиотека для создания «заглушек» (моков) зависимостей, чтобы тестировать класс **в изоляции**.
...
В [модуле 35](../module-35-logging/theory.md) — логирование.
