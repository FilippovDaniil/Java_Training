...
**JSP** (JavaServer Pages) — технология для генерации HTML-страниц с вставками Java-логики. **MVC** — архитектурный паттерн, разделяющий приложение на модель, представление и контроллер (см. также [модуль 37](../m37_software_architecture/theory.md)).
...
В [модуле 42](../m42_web_services/theory.md) — веб-сервисы.
