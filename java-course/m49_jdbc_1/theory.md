...
- Схема таблицы `products` спроектирована в [модуле 48](../module-48-database-design/theory.md) (нормальные формы, ключи).
- Продвинутые возможности JDBC (транзакции, пул соединений, batch) — в [модуле 50](../module-50-jdbc-2/theory.md).
...
В [модуле 50](../module-50-jdbc-2/theory.md) — транзакции, batch-запросы, пул соединений (HikariCP) и паттерн DAO.
