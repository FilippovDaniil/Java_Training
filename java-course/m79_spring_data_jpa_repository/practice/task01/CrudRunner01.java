...
class CrudRunner01 implements CommandLineRunner {
    ...
    @Autowired
    CrudRunner01(ProductRepository01 repo) {
        this.repo = repo;
    }
    ...
    public void run(String... args) {
        ...
        repo.saveAll(List.of(
                new Product01("Кофе",500),
                new Product01("Чай",300),
                new Product01("Сахар",100))
        );
        // TODO: System.out.println("Всего: " + repo.count());
        System.out.println("Всего: " + repo.count());
        // TODO: repo.findById(1L).ifPresent(p -> System.out.println("Первый: " + p.getName()));
        repo.findById(1L).ifPresent(p -> System.out.println("Первый: " + p.getName()));
        // TODO: System.out.println("Есть #1: " + repo.existsById(1L));
        System.out.println("Есть #1: " + repo.existsById(1L));
        // TODO: repo.deleteById(1L); System.out.println("После удаления: " + repo.count());
        repo.deleteById(1L);
        System.out.println("После удаления: " + repo.count());
    }
}
