...
class Runner05 implements CommandLineRunner {
    ...
    @Autowired
    Runner05(OrderRepository05 o, AuditRepository05 a, OrderService05 s) {
        this.orders = o;
        this.audits = a;
        this.service = s;
    }
    ...
    public void run(String... args) {
        try {
            service.placeOrder("Заказ-1", true);
        } catch (Exception e) {
            System.out.println("Откат: " + e.getMessage());
        }

        // TODO: System.out.println("Заказов: " + orders.count() + " (ожидается 0)");
        System.out.println("Заказов: " + orders.count() + " (ожидается 0)");
        // TODO: System.out.println("Аудитов: " + audits.count() + " (ожидается 1)");
        System.out.println("Аудитов: " + audits.count() + " (ожидается 1)");
    }
}
