...
class ProductService05 {
    ...
    @Autowired
    ProductService05(ProductRepository05 repo) {
        this.repo = repo;
    }
    ...
    public void staleUpdate(Long id) {
        ...
        Product05 p1 = repo.findById(id).orElseThrow();
        long oldVersion = p1.getVersion();
        p1.setPrice(100);
        ...
        Product05 stale = new Product05(p1.getName(), 200);
        stale.setId(id); stale.setVersion(oldVersion);
