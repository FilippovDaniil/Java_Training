...
public class Task03 {
    public static void main(String[] args) {
        ...
        try {
            ...
            long total = em.createQuery("select count(p) from Payment03 p", Long.class).getSingleResult();   // в логе — UNION двух таблиц
            System.out.println("всего платежей (UNION): " + total); // 2
