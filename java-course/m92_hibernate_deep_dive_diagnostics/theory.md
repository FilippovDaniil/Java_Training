...
|--------------|---------|---------------|---------|
| **N+1** | 1+N запросов | [86](../module-86-hibernate-deep-dive-fetching/theory.md), [82](../module-82-spring-data-jpa-lazy-loading/theory.md) | JOIN FETCH / EntityGraph / batch / DTO |
| `open-in-view=true` | N+1 в слое view, lazy «магически» работает | [82](../module-82-spring-data-jpa-lazy-loading/theory.md) | `open-in-view=false`, грузить явно |
| EAGER везде | лишние JOIN/запросы всегда | [82](../module-82-spring-data-jpa-lazy-loading/theory.md), [86](../module-86-hibernate-deep-dive-fetching/theory.md) | LAZY + точечный fetch |
| `equals/hashCode` по generated id | объект «теряется» в `Set` | [88](../module-88-hibernate-deep-dive-modeling/theory.md) | бизнес-ключ |
| `ddl-auto=update` в проде | неконтролируемая схема | [84](../module-84-spring-data-jpa-migrations/theory.md) | Flyway + `validate` |
| нет границы транзакции | detached, `LazyInitializationException` | [81](../module-81-spring-data-jpa-transactions/theory.md), [85](../module-85-hibernate-deep-dive-lifecycle/theory.md) | `@Transactional` на сервисе |
| `save()` «на всякий случай» | лишний код | [81](../module-81-spring-data-jpa-transactions/theory.md), [85](../module-85-hibernate-deep-dive-lifecycle/theory.md) | dirty checking для managed |
| построчные правки вместо bulk | тысячи UPDATE | [91](../module-91-hibernate-deep-dive-performance/theory.md) | bulk `update`/`delete` |
| `IDENTITY` для bulk-insert | нет батчинга | [91](../module-91-hibernate-deep-dive-performance/theory.md) | `SEQUENCE` + `batch_size` |
| правка применённой миграции | checksum mismatch | [84](../module-84-spring-data-jpa-migrations/theory.md) | новая версия `V{n+1}` |
...
- [модуль 86](../module-86-hibernate-deep-dive-fetching/theory.md) и [91](../module-91-hibernate-deep-dive-performance/theory.md) — приёмы, которые здесь проверяем.
