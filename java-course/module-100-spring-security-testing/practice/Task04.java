...
record CreateTask04(String title) {}
...
class TaskController04 {
    ...
    String create(@RequestBody CreateTask04 req) { return "created: " + req.title(); }
}
...
class SecurityConfig04 {
    ...
    SecurityFilterChain chain(HttpSecurity http) throws Exception {
        // CSRF включён по умолчанию (session-режим) — csrf НЕ отключаем.
