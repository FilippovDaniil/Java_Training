...
class JwtService05 {
    ...
    JwtService05(@Value("${jwt.secret:01234567890123456789012345678901}") String secret) {
...
class SecurityConfig05 {
    @Bean
    SecurityFilterChain chain(HttpSecurity http, JwtAuthFilter05 filter) throws Exception {
