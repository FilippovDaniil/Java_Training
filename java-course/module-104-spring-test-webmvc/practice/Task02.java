...
record CreateTask02(String title) {}
record TaskDto02(Long id, String title, String status) {}

@Service
class TaskService02 {
    public TaskDto02 create(CreateTask02 req) { return new TaskDto02(0L, req.title(), "NEW"); }
}
...
class TaskController02 {
    ...
    @PostMapping
    public ResponseEntity<TaskDto02> create(@RequestBody CreateTask02 req) {
        TaskDto02 created = service.create(req);
