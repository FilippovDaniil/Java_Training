...
> Анонимные классы часто заменяют лямбдами (см. [модуль 24](../module-24-stream-api-lambda/theory.md)), если интерфейс функциональный.
...
В [модуле 24](../module-24-stream-api-lambda/theory.md) — лямбды и Stream API.
