...
**Лямбда** — это анонимная функция. Компактная замена анонимного класса (см. [модуль 23](../module-23-oop-overloading-overriding-abstract/theory.md)) для функциональных интерфейсов.
...
**Stream** (поток данных — не путать с I/O из [модуля 18](../module-18-io-streams/theory.md)) — это последовательность элементов, над которой выполняется цепочка операций.
...
В [модуле 25](../module-25-multithreading-concurrency/theory.md) — многопоточность.
