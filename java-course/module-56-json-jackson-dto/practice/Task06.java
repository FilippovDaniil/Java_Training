...
/*
 * Ожидаемый вывод шага 4 (без @JsonInclude):
 *   {"id":5,"name":"Ноутбук","price":0.0,"description":null,"imageUrl":null}
 *
 * Ожидаемый вывод шага 6 (с @JsonInclude NON_NULL):
 *   {"id":5,"name":"Ноутбук","price":0.0}
 */
