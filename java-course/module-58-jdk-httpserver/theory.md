...
> Знание HTTP обязательно — см. [модуль 55](../module-55-http-basics/theory.md) и [модуль 57](../module-57-java-http-client/theory.md).
