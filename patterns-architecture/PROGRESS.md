...
**На текущий момент:** создан каркас раздела (`README.md`, `PROGRESS.md`). Контент тем (`theory.md` + задачи) ещё не генерировался.
...
|----|------|---------|-----------|--------|----------|
| 01 | Принципы ООП | `module-01-oop-principles` | ⬜ | ⬜ 0/7 | ⬜ |
| 02 | SOLID: SRP, OCP | `module-02-solid-srp-ocp` | ⬜ | ⬜ 0/7 | ⬜ |
| 03 | SOLID: LSP, ISP, DIP | `module-03-solid-lsp-isp-dip` | ⬜ | ⬜ 0/7 | ⬜ |
...
- _(пусто)_ — здесь фиксируются завершённые батчи: дата, темы, результат проверки, commit.
