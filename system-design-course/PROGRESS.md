...
**На текущий момент:** 🟡 **В работе — готовы Батчи 1–8 (Части 1–5 + Часть 6 под-батч a, модули 01–26): 26/49.** Сгенерировано 312 .md (26×[theory + 10 задач + questions]), скан на кракозябры/NUL/CJK — чисто. **Части 1–5 завершены; Часть 6 — 3/5 (модули 24–26).** Дальше Батч 9 (модули 27–28: нагрузочное тестирование/Chaos Engineering, observability SLI/SLO/error budget — Часть 6 «Надёжность/производительность/масштаб», под-батч b, завершает Часть 6). Детальный план каждого модуля (что обязательно в `theory.md` + темы 10 задач) дописывается в этот файл в начале соответствующего батча, перед генерацией.
...
| 6 — Надёжность/производительность/масштаб | 24–28 | 5 | 🟡 3/5 |
